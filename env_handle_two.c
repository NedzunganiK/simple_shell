...
/**
 * copy_info - Copies the info of an envir var.
 * @name: The name of the envir var.
 * @value: The value of the envir var.
 *
...
/**
 * set_env - Sets value of env var or creates new one if no value
 * @name: The name of the env variable.
 * @value: The value to set for the env var.
