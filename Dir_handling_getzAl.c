...
/**
 * cd_dot - Changes current dir based on the "." and ".." cases.
...
/**
 * cd_to - Changes current working dir to specified directory.
 *
...
/**
 * cd_previous -  Changes current working dir to the previous dir.
 *
 * @datash:  Pointer to the data_shell struct.
 * Return: void
 */
...
/**
 * cd_to_home -  Changes the working dir to the home dir.
 * @datash: Pointer to the data_shell structure.
 * Return: void
 */
